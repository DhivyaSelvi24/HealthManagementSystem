...
<head>
    ...
    <title>Bipolar Test- Score</title>
...
<body>
    ...
    <script>
        ...
        const normalizedScore = totalScore / 14;
   ...
   // Prevent Ctrl+Shift+J (for Mac) from opening developer tools
    ...
    window.addEventListener("keydown", function (e) {     
      ...
      function redirect() {
        window.location.href = `../form/form.php?formName=Bipolar_test&Score=${(normalizedScore * 100).toFixed(0) }`;
