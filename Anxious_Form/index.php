...
<head>
    ...
    <title>Do you feel Anxious?</title>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="h4-container" class="text-center">
                    <h2 class="mt-3">Do you feel Anxious?</h1>
                    <h5 class="header-container mt-3">Take this Anxious test. It’s quick, free, and you’ll get your confidential results instantly.</h4>
                </div>
            </div>
        </div>
    </div>
                ...
                <form id="questionnaireForm" onsubmit="return calculateScore()" class="questionnaire-pop">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question1">1. I worry about things</label>
                        </div>
                        <div class="row mt-4 ">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question2">2. I anticipate the worst</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question3">3. I cannot control my fears</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question4">4. I am irritable</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question5">5. I feel tense</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question6">6. I get startled easily</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question7">7. I break into tears without apparent reason</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question8">8. I get tired quickly</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question9">9. I am unable to relax</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question10">10. I have racing thoughts</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question11">11. My sleep is disturbed</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question12">12. I cannot wake up feeling rested</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question13">13. I find it difficult to concentrate on tasks</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question14">14. I can’t remember things</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question15">15. I am fidgety</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question16">16. My hands tremble</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question17">17. I experience sudden chest pains or rapid heartbeat</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question18">18. I feel like I cannot breathe or am breathing too fast</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question19">19. My mouth goes dry</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question20">20. I avoid certain places, activities or situations</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION  ">
                                <div class="form-check">
