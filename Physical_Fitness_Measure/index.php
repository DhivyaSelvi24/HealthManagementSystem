...
<head>
    ...
    <title>Physical Fitness Measure</title>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="h4-container" class="text-center">
                    <h2 class="mt-3">Physical Fitness Measure</h1>
                    <h5 class="header-container mt-3">Take this Physical Fitness test. It’s quick, free, and you’ll get your confidential results instantly.</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-sm-12">
                <form id="questionnaireForm" onsubmit="return calculateScore()" class="questionnaire-pop">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row">
                            <label class="ques" for="question1">1. I tend to be within 7 kg of my ideal body weight</label>
                        </div>
                        <div class="row mt-4 ">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question2">2. My blood pressure stays within the normal range</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question3">3. I engage in physical exercise lasting 20 minutes or more, at least 4 days a week</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question4">4. I am able to meet physically challenging goals</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question5">5. I do breathing exercises at least 4 days a week</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question6">6. I do stretching exercises at least 4 days a week</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question7">7. I tend to be free of aches and pains</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question8">8. I have a healthy appetite</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question9">9. I have a good amount of physical stamina</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question10">10. I have regular bowel movements</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question11">11. I find it easy to fall asleep at night</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question12">12. I sleep soundly for at least 7 hours a night</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question13">13. I feel rested when I wake up in the morning</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question14">14. I tend to be free of illnesses and infections</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question15">15. I feel enthusiastic</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question16">16. I drink 6-7 glasses of water every day</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question17">17. I have enough energy to do my day's tasks</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question18">18. I take the time to relax for at least a few minutes in a day</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question19">19. I make time for sensual pleasure</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question20">20. I feel fit</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
