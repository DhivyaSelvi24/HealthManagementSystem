...
<head>
    ...
    <title>Are you a protective parent?</title>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="h4-container" class="text-center">
                    <h2 class="mt-3">Are you a protective parent?</h2>
                    <h5 class="header-container mt-3">Take this assessment to evaluate your parenting style quickly and confidentially for free</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-sm-12">
                <form id="questionnaireForm" onsubmit="return calculateScore()" class="questionnaire-pop">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row">
                            <label class="ques" for="question1">1. I feel it is my responsibility to make my child’s life easy</label>
                        </div>
                        <div class="row mt-4 ">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question2">2. I worry about being a good enough parent</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question3">3. I consult more than 2 doctors about my child’s health concerns</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question4">4. I am so busy with my child that I cannot find time for personal or social activities</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question5">5. I stay up at night, worrying about my child</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question6">6. I think parents must protect their children from criticism</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question7">7. I feel restless and I wonder if I am doing enough for my child</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question8">8. I need to know where my child is and what he/she is doing</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question9">9. I don't like my child going out with family if I am not present</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question10">10. I accompany my child on outings</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question11">11. My child asks me before he/she does anything</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question12">12. Playgrounds can be unhygienic, so I prefer indoor play for my child</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question13">13. I ensure that my child’s outdoor activities are supervised</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question14">14. I worry about my child contracting a disease</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question15">15. I worry about my child while I am away (at work or out)</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question16">16. I worry when my child is away from home</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question17">17. I am apprehensive about my child’s schoolwork</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question18">18. I ask my child if he/she misses me when I am not around</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question19">19. I feel I am the only one who knows what is right for my child</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question20">20. I want to ensure that my child excels, else it would hurt his/her confidence</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
