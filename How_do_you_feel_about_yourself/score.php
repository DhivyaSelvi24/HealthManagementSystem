...
<head>
    ...
    <title>How do you feel about yourself? - Score</title>
...
<body>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="header-container" class="text-center">
                    <h2>How do you feel about yourself?</h2>
                </div>
            </div>
        </div>
    </div>
   ...
   // Prevent Ctrl+Shift+J (for Mac) from opening developer tools
    ...
    window.addEventListener("keydown", function (e) {     
      ...
      function redirect() {
        window.location.href = `../form/form.php?formName=feel-about-yourself&Score=${(normalizedScore * 100).toFixed(0) }`;
        return false; 
    }
