...
<head>
    ...
    <title>ADHD Questionnaire - Score</title>
...
<body>
    ...
    <script>
        ...
        const normalizedScore = totalScore / (6 * maximumPossibleScore); 
   ...
   // Prevent Ctrl+Shift+J (for Mac) from opening developer tools
    ...
    window.addEventListener("keydown", function (e) {     
      ...
      function redirect() {
        window.location.href = `../form/form.php?formName=ADHD_Form&Score=${(normalizedScore * 100).toFixed(0) }`;
        return false; 
