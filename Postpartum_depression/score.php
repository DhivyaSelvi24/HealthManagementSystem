...
<head>
    ...
    <title>Postpartum Questionnaire - Score</title>
...
<body>
    ...
    <div class="container col-md-12 col-sm-12 mb-2" id="score-container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
                <h2>Your Postpartum Assessment Result</h2>
                <p class="mt-3">Thanks for completing the assessment. Your score is: <span id="Score">0</span></p>
                <div class="interpretation">
                    <p>Congratulations on taking this step towards understanding your well-being!</p>
    ...
    <form name="Postpartum_Form"></form>
    ...
    <script>
        ...
        const normalizedScore = totalScore / (10 * maximumPossibleScore); 

        document.getElementById('Score').innerText = (normalizedScore * 100).toFixed(2) + '%';
   ...
   // Prevent Ctrl+Shift+J (for Mac) from opening developer tools
    ...
    window.addEventListener("keydown", function (e) {     
      ...
      function redirect() {
        window.location.href = `../form/form.php?formName=Postpartum_Form&Score=${(normalizedScore * 100).toFixed(0) }`;
        return false; 
