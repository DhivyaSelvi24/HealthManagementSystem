...
<body>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="header-container" class="text-center">
                    <h2>Self-Injury Questionnaire</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container col-md-12 col-sm-12 mb-2" id="score-container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
                <h2>Your Self-Injury Test Score</h2>
    ...
    <script>
        ...
        const normalizedScore = totalScore / (12 * maximumPossibleScore); 
   ...
   // Prevent Ctrl+Shift+J (for Mac) from opening developer tools
    ...
    window.addEventListener("keydown", function (e) {     
      ...
      function redirect() {
        window.location.href = `../form/form.php?formName=Self_injury&Score=${(normalizedScore * 100).toFixed(0) }`;
