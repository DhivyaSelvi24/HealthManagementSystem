...
<head>
    ...
    <title>Child’s Mental Health</title>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="h4-container" class="text-center">
                    <h2 class="mt-3">Parent Test: Your Child’s Mental Health</h2>
                    <h5 class="header-container mt-3">Take this Child's Mental Health test. It’s quick, free, and you’ll get your confidential results instantly.</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-sm-12">
                <form id="questionnaireForm" onsubmit="return calculateScore()" class="questionnaire-pop">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="row">
                            <label class="ques" for="question1">1. How often your child feels sad, unhappy</label>
                        </div>
                        <div class="row mt-4 ">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question2">2. How often your child feels hopeless</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question3">3. How often your child is down on self</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question4">4. How often your child worries a lot</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question5">5. How often your child seems to be having less fun</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question6">6. How often your child fidgety, unable to sit still</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question7">7. How often your child daydreams too much</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question8">8. How often your child distracted easily</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question9">9. How often your child has trouble concentrating</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question10">10. How often your child acts as if driven by a motor</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question11">11. How often your child fights with other children</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question12">12. How often your child does not listen to rules</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question13">13. How often your child does not understand other people’s feelings</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question14">14. How often your child teases others</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question15">15. How often your child blames others for his/her troubles</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question16">16. How often your child refuses to share</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question17">17. How often your child takes things that do not belong to him/her</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
