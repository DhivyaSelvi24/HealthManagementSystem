...
<head>
    ...
    <title>Mental Health Tracker - Score</title>
...
<body>
    ...
    <form name="Mental_Health_Tracker"></form>
    ...
    <script>
        ...
        const maximumPossibleScore = 3; 
        const normalizedScore = totalScore / (2 * maximumPossibleScore); 
...
//PREVENT RIGHT-CLICK AND SHORTCUTS
   ...
   // Prevent Ctrl+Shift+J (for Mac) from opening developer tools
    ...
    window.addEventListener("keydown", function (e) {     
      ...
      function redirect() {
        window.location.href = `../form/form.php?formName=Mental_Health_Tracker&Score=${(normalizedScore * 100).toFixed(0) }`;
        return false; 
    }
