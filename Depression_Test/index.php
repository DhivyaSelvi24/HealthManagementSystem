        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="h4-container" class="text-center">
                    <h2 class="mt-3">Am I sad or depressed?</h1>
                    <h5 class="header-container mt-3">Take this Depression test. It’s quick, free, and you’ll get your confidential results instantly.</h4>
                </div>
            </div>
        </div>
    </div>
                ...
                <form id="questionnaireForm" onsubmit="return calculateScore()" class="questionnaire-pop">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question1">1. I feel sad and low</label>
                        </div>
                        <div class="row mt-4 ">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question2">2. I feel disinterested in things that earlier seemed pleasurable</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question3">3. I feel I should be (or I am being) punished</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question4">4. I feel guilty</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question5">5. I have difficulty making decisions</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question6">6. I feel tired and low on energy</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question7">7. I believe that nothing will ever work out for me</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question8">8. I have difficulty in concentrating</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question9">9. I feel irritated</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question10">10. I feel restless and anxious</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question11">11. I cry (or I feel like crying)</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question12">12. I have thoughts about ending my life</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question13">13. I feel like a failure</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question14">14. I feel like I am alone (or want to be alone)</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question15">15. It takes me a lot of effort to do the smallest of things</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question16">16. I feel helpless</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question17">17. I don't feel happy even when good things happen</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question18">18. I think my life isn't worth living</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row  ">
                            <div class="col-md-12 col-sm-12  ">
                                <img src="images\ques-19.webp" alt="Your Image" class="mx-auto d-block" style="width:40px">
                            </div>  
                        </div>

                        <div class="row ques-row">
                            <label class="ques" for="question19">19. I am eating significantly more (or less) than usual</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question20">20. My sleep is disturbed (unrestful or broken sleep)</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
