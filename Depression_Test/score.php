...
<head>
    ...
    <title>Am I sad or depressed? - Score</title>
...
<body>
    ...
    <div class="container col-md-12 col-sm-12 mb-2" id="score-container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
                <h2>Your Depression Test Score</h2>
    ...
    <form name="depression_form"></form>
   ...
   // Prevent Ctrl+Shift+J (for Mac) from opening developer tools
    ...
    window.addEventListener("keydown", function (e) {     
      ...
      function redirect() {
        window.location.href = `../form/form.php?formName=depression_form&Score=${(normalizedScore * 100).toFixed(0) }`;
        return false; 
    }
    </script>
