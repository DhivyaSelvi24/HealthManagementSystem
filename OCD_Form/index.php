        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="h4-container" class="text-center">
                    <h2 class="mt-3">OCD Questionnaire</h1>
                    <h5 class="header-container mt-3">Take this OCD test. It’s quick, free, and you’ll get your confidential results instantly.</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-sm-12">
                <form id="questionnaireForm" onsubmit="return calculateScore()" class="questionnaire-pop">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question1">1. I experience unwanted thoughts repeatedly, and I am not able to stop them</label>
                        </div>
                        <div class="row mt-4 ">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question2">2. I have the urge to carry out certain actions repeatedly in order to relieve my anxiety</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question3">3. I am uncomfortable when items in my surroundings are not arranged as they should be</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question4">4. I rearrange items in my surroundings till they are perfectly placed</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question5">5. I worry about getting contaminated from unclean surfaces</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question6">6. It is compulsory for me to repeatedly and thoroughly clean myself, sometimes even when I simply feel unclean</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question7">7. Thoughts of possible mishaps come to my mind repeatedly and make me anxious</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question8">8. I experience uncontrollable urges to check electrical appliances/gas stoves/locks and so on</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question9">9. I get forbidden thoughts/images (sexual, hostile and violent) resulting in guilt</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question10">10. I feel the need to absolve myself of guilt-inducing thoughts/images by doing something to undo them</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question11">11. The thought of me engaging in blasphemous thoughts/actions worries me</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question12">12. I feel the urge to pray and devote myself to religious activity to make amends for my sins</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question13">13. The possible uncertainty about a situation is unsettling for me</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question14">14. I feel the need to repeatedly ask others for assurance about events I have doubts about</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question15">15. I experience remarkable distress as a result of the repetitive, unwanted thoughts and urges</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question16">16. I am unable to ignore the intrusive thoughts and/or stop myself from engaging in repetitive actions</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question17">17. The repetitive, disturbing thoughts, urges and images tend to interfere markedly with my daily tasks/responsibilities</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <!--  Image  -->
                        ...
                        <div class="row ">
                            <label class="ques" for="question18">18. I avoid certain objects or situations out of worry of getting unwanted thoughts leading to repetitive behavior</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
