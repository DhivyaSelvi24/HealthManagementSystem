...
<head>
    ...
    <title>OCD Questionnaire - Score</title>
...
<script>
        ...
        const normalizedScore = totalScore / (18 * maximumPossibleScore); 
   ...
   // Prevent Ctrl+Shift+J (for Mac) from opening developer tools
    ...
    window.addEventListener("keydown", function (e) {     
      ...
      function redirect() {
        window.location.href = `../form/form.php?formName=OCD_Form&Score=${(normalizedScore * 100).toFixed(0) }`;
