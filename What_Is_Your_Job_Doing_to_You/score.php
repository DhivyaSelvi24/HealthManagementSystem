...
<head>
    ...
    <title>What Is Your Job Doing to You? - Score</title>
...
<body>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="header-container" class="text-center">
                    <h2>What Is Your Job Doing to You?</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container col-md-12 col-sm-12 mb-2" id="score-container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
                <h2>Your Job Impact Test Score</h2>
   ...
   // Prevent Ctrl+Shift+J (for Mac) from opening developer tools
    ...
    window.addEventListener("keydown", function (e) {     
      ...
      function redirect() {
        window.location.href = `../form/form.php?formName=Job_Form&Score=${(normalizedScore * 100).toFixed(0) }`;
        return false; 
    }
