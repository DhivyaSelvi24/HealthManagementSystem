...
<head>
    ...
    <title>What Is Your Job Doing to You?</title>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="h4-container" class="text-center">
                    <h2 class="mt-3">What Is Your Job Doing to You?</h2>
                    <h5 class="header-container mt-3">Take this assessment to understand your job's impact on you.  It's quick, free, and confidential </h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-sm-12">
                <form id="questionnaireForm" onsubmit="return calculateScore()" class="questionnaire-pop">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row">
                            <label class="ques" for="question1">1. I feel like I have too much to do at the same time</label>
                        </div>
                        <div class="row mt-4 ">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question2">2. People call me a workaholic</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question3">3. I sleep less than 6 hours at night</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question4">4. I do not get the time to do anything for myself</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question5">5. I feel irritable, and lose my temper easily</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question6">6. I barely spend any time at home</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question7">7. Although physically at home, mentally I’m at work</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question8">8. I take work calls beyond work hours</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question9">9. I stay up at night to complete work</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question10">10. I wish I had more time to pursue my hobbies</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question11">11. I am unable to relax even on vacation</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question12">12. I feel exhausted and drained of energy</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question13">13. I feel stressed or overwhelmed</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question14">14. I have missed family events because of work</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question15">15. My friends complain that my work comes before them</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question16">16. I keep checking my phone/email for updates from work</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question17">17. It’s difficult to take time off from work when I need it</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question18">18. My family gets upset about my work hours</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question19">19. My family and I argue over my home responsibilities</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question20">20. I wish I had lesser work obligations</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
