...
<head>
    ...
    <title>Can You Rely on Your Partner?</title>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="h4-container" class="text-center">
                    <h2 class="mt-3">Can You Rely on Your Partner?</h1>
                    <h5 class="header-container mt-3">Take this assessment to evaluate your partner's reliability for a trustworthy relationship</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-sm-12">
                <form id="questionnaireForm" onsubmit="return calculateScore()" class="questionnaire-pop">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row">
                            <label class="ques" for="question1">1. I can tell my partner anything about myself</label>
                        </div>
                        <div class="row mt-4 ">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question2">2. If I ask my partner for something, it will be done</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question3">3. My partner respects things that are important to me</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question4">4. My partner involves me in decisions</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question5">5. My partner makes an effort to understand me</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question6">6. My partner communicates with me even when angry</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question7">7. My partner and I get along like good friends</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question8">8. My partner trusts me</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question9">9. We make an effort to resolve our arguments</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question10">10. My partner tries to comfort me when I am upset</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question11">11. My partner keeps his/her promises</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question12">12. My partner is on time for our dates, movies and dinners</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question13">13. My partner is honest with me</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question14">14. My partner is mindful of my feelings</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question15">15. My partner finishes most tasks he/she initiates</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question16">16. My partner is interested in what I have to say</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question17">17. My partner is consistent</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question18">18. My partner is relaxed around me</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question19">19. My partner takes responsibility for his/her actions</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question20">20. I turn to my partner for support</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
