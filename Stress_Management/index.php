...
<head>
    ...
    <title>How well do you cope with stress?</title>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="h4-container" class="text-center">
                    <h2 class="mt-3">How well do you cope with stress?</h2>
                    <h5 class="header-container mt-3">Take this Stress Management Test. It’s quick, free, and you’ll get your confidential results instantly.</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-sm-12">
                <form id="questionnaireForm" onsubmit="return calculateScore()" class="questionnaire-pop">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="row">
                            <label class="ques" for="question1">1. I get upset when things happen unexpectedly</label>
                        </div>
                        <div class="row mt-4 ">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question2">2. I feel I cannot control important events in my life</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question3">3. I worry about a lot of things</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question4">4. I feel incapable of handling my problems</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question5">5. I find it difficult to adapt to change</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question6">6. It seems like I am listening but I am preoccupied with other things</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question7">7. My mood changes quickly, without apparent reason</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question8">8. I feel there is too much to do and too little time</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question9">9. I am unable to finish what I start</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question10">10. I feel exhausted</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question11">11. I have difficulty falling or staying asleep</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question12">12. I get worked up when my plans fail</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question13">13. I feel like I am losing control</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question14">14. I struggle with managing my time</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question15">15. I find it difficult to concentrate on tasks and make decisions</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question16">16. I have racing thoughts that make me feel anxious</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question17">17. I withdraw from others when stressed</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question18">18. I eat more or less than usual when stressed</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question19">19. My heart beats fast and/or my hands tremble</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question20">20. I experience headaches</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
