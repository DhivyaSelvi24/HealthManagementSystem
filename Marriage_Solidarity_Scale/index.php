...
<head>
    ...
    <title>Marriage Solidarity Scale Test</title>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="h4-container" class="text-center">
                    <h2 class="mt-3">Marriage Solidarity Scale Test</h2>
                    <h5 class="header-container mt-3">Take this Marriage Solidarity Test. It’s quick, free, and you’ll get your confidential results instantly.</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-sm-12">
                <form id="questionnaireForm" onsubmit="return calculateScore()" class="questionnaire-pop">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row">
                            <label class="ques" for="question1">1. My marriage fulfills my emotional needs</label>
                        </div>
                        <div class="row mt-4 ">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question2">2. Being married brings me happiness</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question3">3. We communicate with each other openly and honestly</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question4">4. We try to resolve our differences even when we are angry</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question5">5. We rely on each other</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question6">6. My spouse makes an effort to be involved in several aspects of my life</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question7">7. I feel attached to my spouse</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question8">8. We prioritise spending time together</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question9">9. We treat each other as equal partners in our marriage</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question10">10. We try to listen to and understand each other</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question11">11. When I think about the future of our relationship, I feel happy</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question12">12. I feel committed to my marriage</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question13">13. We find it easy to trust each other</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question14">14. We make time for intimacy, and enjoy it</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question15">15. We are willing to apologise to each other for our mistakes</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question16">16. We appreciate each other</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question17">17. We make joint decisions about our savings and expenditures</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question18">18. I can be genuine around my spouse</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question19">19. Our core values tend to be aligned</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="row  ">
                        ...
                        <div class="row ">
                            <label class="ques" for="question20">20. I feel supported to pursue my own interests in this marriage</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
