...
<head>
    ...
    <title>Marriage Solidarity Scale Test - Score</title>
...
<body>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="header-container" class="text-center">
                    <h2>Marriage Solidarity Scale Test </h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container col-md-12 col-sm-12 mb-2" id="score-container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
                <h2>Your Marriage Solidarity Scale Test Score</h2>
    ...
    <form name="Marriage_Solidarity_Scale"></form>
   ...
   // Prevent Ctrl+Shift+J (for Mac) from opening developer tools
    ...
    window.addEventListener("keydown", function (e) {     
      ...
      function redirect() {
        window.location.href = `../form/form.php?formName=Marriage_Solidarity_Scale&Score=${(normalizedScore * 100).toFixed(0) }`;
        return false; 
    }
