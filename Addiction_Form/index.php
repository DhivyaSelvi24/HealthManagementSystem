...
<head>
    ...
    <title>Is My Addiction in My Control?</title>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="h4-container" class="text-center">
                    <h2 class="mt-3">Is My Addiction in My Control?</h1>
                    <h5 class="header-container mt-3">Take this Addiction test. It’s quick, free, and you’ll get your confidential results instantly.</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-sm-12">
                <form id="questionnaireForm" onsubmit="return calculateScore()" class="questionnaire-pop">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question1">1. If I make up my mind, I can resist my addiction</label>
                        </div>
                        <div class="row mt-4 ">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question2">2. I feel unlucky that I am hooked to the substance I use</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question3">3. I feel helpless when I am consuming the substance</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question4">4. My addiction is my responsibility</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question5">5. It becomes difficult to resist when everyone around is enjoying the substance</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question6">6. Helplessness drives me to addiction</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question7">7. When I get a temptation for consuming a substance, I cannot control it</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question8">8. These substances are too powerful, hence it is hard to give them up</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question9">9. I use addictive substances to curb my anxiety</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question10">10. I get drawn to addictive substances when nothing else is going well for me</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question11">11. Pressures from home and work drive me to addiction</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question12">12. Recovery from my addiction seems impossible</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question13">13. When one is addicted, relapses will always occur</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question14">14. I feel in control of myself in general</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question15">15. I am responsible for my substance use</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question16">16. I have not had the right support to help me quit</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question17">17. No matter how hard I try, the temptation to consume the substance returns</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question18">18. If I have to quit, it will happen one day on its own</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question19">19. I feel powerless over my addiction</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ques-row">
                            <label class="ques" for="question20">20. Pressure from friends makes me consume these substances</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
