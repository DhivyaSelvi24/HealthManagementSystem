...
<head>
    ...
    <title>Eating Disorder Test - Score</title>
...
<body>
    ...
    <script>
        ...
        const normalizedScore = totalScore / (11 * maximumPossibleScore); 
   ...
   // Prevent Ctrl+Shift+J (for Mac) from opening developer tools
    ...
    window.addEventListener("keydown", function (e) {     
      ...
      function redirect() {
        window.location.href = `../form/form.php?formName=Eating_disorder&Score=${(normalizedScore * 100).toFixed(0) }`;
