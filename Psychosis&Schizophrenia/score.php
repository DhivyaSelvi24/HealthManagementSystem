...
<head>
    ...
    <title>Psychosis & Schizophrenia Test- Score</title>
...
<body>
    ...
    <div class="container col-md-12 col-sm-12 mb-2" id="score-container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
                <h2>Your Psychosis Test Score</h2>
    ...
    <script>
        ...
        const normalizedScore = totalScore / 21;
   ...
   // Prevent Ctrl+Shift+J (for Mac) from opening developer tools
    ...
    window.addEventListener("keydown", function (e) {     
      ...
      function redirect() {
        window.location.href = `../form/form.php?formName=Psychosis_Form&Score=${(normalizedScore * 100).toFixed(0) }`;
