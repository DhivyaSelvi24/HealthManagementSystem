...
<head>
    ...
    <title>Are You Sleeping Well?</title>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div id="h4-container" class="text-center">
                    <h2 class="mt-3">Are You Sleeping Well?</h1>
                    <h5 class="mt-3 header-container">Take this Sleep test. It’s quick, free, and you’ll get your confidential results instantly.</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-sm-12">
                <form id="questionnaireForm" onsubmit="return calculateScore()" class="questionnaire-pop">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="row">
                            <label class="ques" for="question1">1. I go to sleep and wake up at the same time every day</label>
                        </div>
                        <div class="row mt-4 ">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question2">2. I eat my food in bed
                            </label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question3">3. I read in bed before I go to sleep</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question4">4. I watch TV on my bed</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question5">5. I exercise 3-4 hours before bedtime</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question6">6. I have tea or coffee within 3 hours of going to bed</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question7">7. I smoke close to bedtime (if non-smoker then select never)</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question8">8. I consume alcohol within 3 hours of going to bed</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question9">9. I finish my meal 2 hours prior to bedtime</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question10">10. I drink a lot of water (or other fluids) within 3 hours of going to bed</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question11">11. I save some time in the day to unwind and relieve myself of my day’s stress</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question12">12. I have a hot shower before sleeping</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question13">13. I immediately go to bed once I start feeling sleepy</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question14">14. My bed or sleeping area is quiet and distraction free</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question15">15. I wake up in the morning feeling rested</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question16">16. I take daytime naps that last more than 2 hours in all</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question17">17. I go to bed nervous and worried</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question18">18. If I have slept late, then I wake up late the next day</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question19">19. I use coffee to stay awake in the day</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="row ">
                            <label class="ques" for="question20">20. I have a light snack before I sleep</label>
                        </div>
                        <div class="row mt-4 ">
                            <div class="col-md-2 OPTION">
                                <div class="form-check">
