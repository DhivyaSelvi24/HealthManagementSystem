...
<head>
    ...
    <title>Are You Sleeping Well? - Score</title>
...
<body>
    ...
    <div class="container col-md-12 col-sm-12" id="score-container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
                <h2>Your Sleep Test Score</h2>
   ...
   // Prevent Ctrl+Shift+J (for Mac) from opening developer tools
    ...
    window.addEventListener("keydown", function (e) {     
      ...
      function redirect(){
        window.location.href = `../form/form.php?formName=Sleep_Form&Score=${(normalizedScore * 100).toFixed(0) }`;
        return false; 
      }
    </script>
